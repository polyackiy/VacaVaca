"""
Django settings for vacavaca project.
...
SECRET_KEY = 'romk0%uwwz-@^85yso=c+&hyu%hr!k9g8ln=5xvkewm4*alwyd'
...
WSGI_APPLICATION = 'vacavaca.wsgi.application'
